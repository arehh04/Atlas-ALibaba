...
echo [1/2] Starting FastAPI + LangGraph Backend (Port 8000)...
start "SynapseAir Backend" cmd /k "cd /d %~dp0backend && python -m uvicorn main:app --host 127.0.0.1 --port 8000 --reload"
...
echo - SSE Stream Stream:  http://127.0.0.1:8000/stream/:thread_id
echo ======================================================================
pause
